...
- [x] Define owner-scoped harness contract (catalog, assignment, allow/deny, and deterministic execution profile/key selection). Detailed plan: [runner-connection.plan.md](./runner-connection.plan.md)
