...
import { credentialConfig } from "@components/config/credential-config.js";
...
const getEncryptionKey = (): Buffer => createHash(`sha256`).update(credentialConfig.encryptionKey).digest();
